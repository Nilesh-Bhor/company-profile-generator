...
from utils.utility import encode_profile_data
...
if 'is_shared_view' in st.session_state and st.session_state.is_shared_view:
    st.set_page_config(page_title="Company Profile", page_icon="📋", layout="centered")
...
def create_download_buttons(include_share=True):
    try:
        ...
        print("Error creating download buttons ")
